...
MetronicApp.controller('ListController', ['$rootScope', '$http', '$scope', '$timeout', 'metadata', function ($rootScope, $http, $scope, $timeout, metadata) {
    ...
    $scope.$on('$viewContentLoaded', function () {
        ...
        // init the table
        TableAjax.init($rootScope.$state.$current.data.model);
        ...
        $http({
            ...
            url: Metronic.rootPath() + "/index.php?s=/addon/School/Admin/getFieldList/model/" + $scope.model
    ...
    $scope.save = function () {
        for (var name in $scope.info) {
            //if ($scope.info[key] == null) {
            //    continue;
            //}
            //var value = $scope.info[key].value
