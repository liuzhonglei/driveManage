...
class EO2OPaymentController extends EO2OBaseController
{
    ...
    {
        $info = parent::_list_grid($model); // TODO: Change the autogenerated stub
        array_push($info['fields'], "student_id");
        return $info;
    }
        ...
        foreach ($list_data['list_data'] as &$data) {
            ...
            if (!empty($data["student_id"])) {
                ...
                if (!empty($info["openid"])) {
                    $info = M('follow')->where('token = "' . get_token() . '" and openid="' . $info["openid"] . '"')->find();
                    $data["nickname"] = $info["nickname"];
                }
            }
        }
