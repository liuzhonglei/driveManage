...
Res = ["http://t2.qpic.cn/mblogpic/53906b453e48eb290e34/120", "http://t2.qpic.cn/mblogpic/7a22839181b07a690ecc/120", "http://t2.qpic.cn/mblogpic/7e90dde8ac83ffd16b58/120", "http://t2.qpic.cn/mblogpic/f13da5af094ec552f0bc/120", "http://t2.qpic.cn/mblogpic/97bf0271a41eb311249a/120", "http://t2.qpic.cn/mblogpic/52bef08d35e6d8f36e7c/120", "http://t2.qpic.cn/mblogpic/62a31b4cf34795cc5e2c/120", "http://t2.qpic.cn/mblogpic/9960d7a52d32ba39d3fa/120", "http://t2.qpic.cn/mblogpic/55dc25c83d4eb9d23ba0/120", "http://t2.qpic.cn/mblogpic/36f94de5be883f5a6692/120", "http://t2.qpic.cn/mblogpic/f13da5af094ec552f0bc/120", "http://t2.qpic.cn/mblogpic/d2a78fdd1659381753a4/460", "http://t2.qpic.cn/mblogpic/830f59fcde1e5279f01a/460", "http://t2.qpic.cn/mblogpic/f8aa2f3ca6d4a2bb1622/460", "http://t1.qpic.cn/mblogpic/59a79dc060d981fe15b0/460", "http://t2.qpic.cn/mblogpic/d41a598521a46d91ffaa/80", "http://t2.qpic.cn/mblogpic/54b4a15b4ec611d6337e/460"],
timeoutData = [{
	max: 30,
	...
	m = {
		...
		gameOver: function(a) {
			...
			b.switchPage("gameover"); {
				...
				g > 0 ? "我一分钟亲了" + b.score + "个showgirl！肯定比你多，不信你试试？": shareDataX.tTitle
			}
			"timeout" == a ? (c = this.filterText(g, timeoutData), d = c.desc.replace(/#score#/, g), e = "恭喜你将她领回家~", l.title = "我亲到" + g + "个美女，击败了全国" + h + "%的勇士，征服一个领回家，开心回家生孩子咯~！") : (c = this.filterText(g, suicideData), d = c.desc, e = "恭喜你将他领回家~", l.title = g > 0 ? "万千showgirl丛中过，偏偏眼瞎亲如花！我只击败了全国" + h + "%的勇士……你来试试？": "很遗憾！我没有亲到美女，是全国唯一垫底的勇士！只有如花和我回家！"),
			l.desc = "我亲到" + g + "个美女！看看你能亲到几个？肯定比你多，不信你试试！！！";
		...
		initShareEvent: function() {
			...
			function() {
				...
				function() {
					a.score > 0 ? "我一分钟亲了" + a.score + "个showgirl！肯定比你多，不信你试试？": shareDataX.tTitle;
					WeixinJSBridge.invoke("sendAppMessage", {
						img_url: shareDataX.imgUrl,
						link: shareDataX.timeLineLink,
						desc: l.desc,
						title: l.title
					},
					function() {document.location.href = hotUrl;})
		...
		kiss: function(a, b) {
			var c = $(f[a]),
			d = '<img src="http://t2.qpic.cn/mblogpic/54b4a15b4ec611d6337e/460" />';
			c.html(d),
