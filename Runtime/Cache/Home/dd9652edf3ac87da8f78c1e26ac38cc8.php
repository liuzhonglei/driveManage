...
<link type="text/css" rel="stylesheet" href="/Public/Home/css/about.css?v=<?php echo SITE_VERSION;?>" />
</head>
<body>
	<div class="head">
    	<div class="wrap">
            ...
            <div class="nav">
                ...
                <a href="<?php echo U('home/index/cloud');?>" class="has_icon">专属云主机<em class="icon"><img src="/Public/Home/images/new.gif" alt=""/></em></a>
