    ...
    createMarker(item, num) {
        ...
        qq.maps.event.addListener(marker, 'click', function () {
            ...
            info.setContent(
                ...
                + '<div style="text-align:right;font-size: 0.8em;font-weight:bolder;"><a style="color:black;" href="#/service/info/' + item.token + '">报名<img  style="height: 1.1em;" src="../img/sign.png"></a></div>'
            );
